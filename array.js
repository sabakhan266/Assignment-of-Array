...
console.log("\n \t \t Answer no : 3\n");
let thirdelement = ["apple", "banana", "mango", "orange"];
...
//method.
console.log("\n \t \t Answer no: 5 \n");
let fruits_name = ["Apple", "Mango", "Banana", "Pineapple"];
...
console.log("\n \t \t Answer no: 6 \n");
let new_fruits = ["gava", "Mango", "Apple", "orange"];
...
console.log("\n \t \t Answer no : 7 \n");
let fruits_lest = ["orange", "Mango", "Pinaple", "Gave", "Cherry"];
...
//using the method.
console.log("\n \t \t Answer no : 8 \n");
let fruits00 = ["Blueberry", "Pinaple", "Graps"];
...
//using the method.
console.log("\n \t \t Answer no : 9 \n");
let fruits0 = ["Orange", "Peach", "Graps", "Banana"];
fruits0.shift();
fruits0.shift();
// fruits0.splice(0,1);
console.log(fruits0);
...
console.log("\n \t \t Answer no : 10 \n");
let fruits01 = ["Orange", "Peach", "Pinaple",];
...
console.log("\n \t \t Answer no : 11 \n");
let fruits_list1 = ["Orange", "Peach", "Pear"];
let citrusFruits = fruits_list1.slice(0, 2);
console.log(citrusFruits);
// Question:12
//Create a new array named lastTwoFruits that contains the last 
//two elements of the fruits array using the  method.
console.log("\n \t \t Answer no : 12 \n");
let fruitList3 = ["Orange", "Peach", "pear", "gava", "Apple"];
let lastTwofruits = fruitList3.slice(-2);
